...
class _DashboardState extends State<Dashboard> {
  ...
  Widget build(BuildContext context) {
    return GradientBackground(
      child: Scaffold(
        ...
        body: SafeArea(
          child: Obx(() => _screens[dashboardController.selectedIndex.value]),
        ),
  ...
  Widget _buildNavItem(int index, String iconPath, String label) {
    return Obx(() {
      final bool isSelected = dashboardController.selectedIndex.value == index;

      return InkWell(
        onTap: () => dashboardController.updateSelectedIndex(index),
        child: Container(
          decoration: BoxDecoration(
